...
__all__ = [ 'FontEvents', 'OLE_YPOS_PIXELS', 'Unchecked',
           'Monochrome', 'VgaColor', 'OLE_XPOS_CONTAINER', 'Font',
           'OLE_XPOS_HIMETRIC', 'FONTSTRIKETHROUGH', 'FONTNAME',
           'IPictureDisp', 'OLE_YSIZE_CONTAINER', 'OLE_OPTEXCLUSIVE',
           'IPicture', 'Color', 'OLE_XPOS_PIXELS', 'OLE_CANCELBOOL',
           'OLE_XSIZE_PIXELS', 'OLE_TRISTATE', 'FONTITALIC',
           'FONTSIZE', 'LoadPictureConstants', 'OLE_YSIZE_HIMETRIC',
           'Gray', 'IFontEventsDisp', 'IFontDisp', 'IFont', 'StdFont',
           'OLE_HANDLE', 'OLE_YPOS_HIMETRIC', 'Checked',
           'FONTUNDERSCORE', 'OLE_XSIZE_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'FONTBOLD', 'StdPicture',
           'OLE_YSIZE_PIXELS', 'OLE_COLOR', 'OLE_YPOS_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'Picture', 'Default']
from comtypes import _check_version; _check_version('1.1.10', 1523489685.276628)
